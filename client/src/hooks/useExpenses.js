...
const useExpenses = () => {
    ...
    // ------------------------- 
    // Below code was these analysis only depends on the expenseList means it only calculate current page data
    // Analytics
    // -------------------------
    ...
    //     return Object.keys(expensesByCategory).map(
    //         (category) => ({
    //             category,
    ...
    return {
        ...
        // Analytics
        ...summary, // essentially makes those properties available directly from the hook: // hum baad me summary ke andar ke properties ko access or destructure kr skte hain
        summaryLoading,
        summaryError,
...
//             setLoading(false);
//         }
//     }, [debouncedSearch, sortOption, filterType, filterCategory, page]);
